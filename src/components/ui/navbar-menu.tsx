...
export const Menu = ({
    ...
    return (
        <nav
            ...
            className="relative sm:rounded-full boder border-transparent dark:bg-black dark:border-white/[0.2] bg-white shadow-input flex justify-center space-x-4 px-8 py-4 sm:py-6 "
        >
            {children}
        </nav>
    );
