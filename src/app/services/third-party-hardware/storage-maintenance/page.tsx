                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between lg:justify-center">
                        <div className='my-24 flex lg:w-[80%] flex-col gap-10'>
                            ...
                            <p className="text-base font-medium lg:w-[95%]">
                                At Digital4India, we understand that your storage systems are critical to your business operations. Our dedicated team is committed to maximizing the uptime of your equipment through tailored storage maintenance and support solutions. We provide flexible service level agreements designed to align with your organization’s unique storage lifecycle management needs, ensuring that you receive the right level of service at the right time. With our proactive monitoring and preventative maintenance strategies, we aim to minimize disruptions and keep your data accessible when you need it most.
                            </p>
                            <p className="text-base font-medium lg:w-[95%]">
                                In addition to our customized maintenance plans, we offer 24/7 support through our global call centers, ensuring that expert assistance is always just a phone call away. Whether you face unexpected issues or require guidance on optimizing your storage solutions, our knowledgeable technicians are ready to help. With Digital4India by your side, you can focus on driving your business forward, knowing that your storage systems are in capable hands.
                            </p>
                        </div>
                    </div>
                </div>
