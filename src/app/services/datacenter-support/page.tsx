                ...
                <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white'>
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between lg:justify-center">
                        <div className='my-24 flex lg:w-[80%] flex-col gap-10'>
                            ...
                            <p className="text-base font-medium lg:w-[95%]">
                                Furthermore, our interconnection services deliver unparalleled global connectivity, ensuring that your data can seamlessly interact with partners, providers, and customers worldwide. This virtual and physical connectivity enhances disaster recovery strategies and boosts the security and performance of your mission-critical applications. With our Build-to-Suit services, you also have the ability to fully customize your colocation environment, with eco-friendly designs that align with your sustainability goals. Digital4India datacenter support gives your business the infrastructure it needs to stay ahead in the fast-evolving digital landscape.</p>
                        </div>
                    </div>
                </div>
            </section>
