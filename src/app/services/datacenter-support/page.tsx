...
function DatacenterSupport() {
    return (
        <>
            <section className="w-full">
                <div className="w-full h-[520px] bg-[url('https://ik.imagekit.io/kvimages/it-services-images/18847.jpg?updatedAt=1719040681447')] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
                    <div className="flex flex-col items-center mx-auto px-4 pt-6 md:px-8 text-center">
                        <h1 className="text-white font-bold text-4xl md:text-6xl leading-tight mb-6">Datacenter Support & Service</h1>
            ...
            <div className='bg-slate-900 flex flex-col items-center gap-10 lg:flex-row justify-center text-white'>
                <div className="my-24 flex w-[90%] lg:w-[70%] flex-col gap-10">
                    ...
                    <p className="text-base md:text-lg font-medium text-center">
                    Experience a complete IT infrastructure solution with our state-of-the-art datacenter support. From installation to maintenance, we provide end-to-end services to ensure your data is secure, accessible, and efficiently managed.
                    </p>
                </div>
            </div>
