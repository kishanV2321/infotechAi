...
function SoftwareDevelopemnt() {
    return (
        <>
            <section className="w-full">
                <div className="w-full h-[520px] bg-[url('https://ik.imagekit.io/kvimages/it-services-images/4380747.jpg?updatedAt=1719040473057')] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
                    <div className="flex flex-col items-center mx-auto px-4 pt-6 md:px-8 text-center">
                        <h1 className="text-white font-bold text-4xl md:text-6xl leading-tight mb-6">Software Development</h1>
                        <p className="text-white text-lg md:text-2xl mb-6">The Best in Software Development.</p>
                        <div className='w-fit'>
            ...
            <div className='bg-slate-900 flex flex-col items-center gap-10 lg:flex-row justify-center text-white'>
                <div className="my-24 flex w-[90%] lg:w-[70%] flex-col gap-10">
                    ...
                    <p className="text-base md:text-lg font-medium text-center">
                        Transform your ideas into reality with our custom software development services. From website design to mobile apps and ERP software, we create innovative solutions that drive your business forward.
                    </p>
                </div>
            </div>
...
export default SoftwareDevelopemnt