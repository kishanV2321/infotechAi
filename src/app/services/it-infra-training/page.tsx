    ...
    return (
        <>
            <section className="w-full">
                <div className="w-full h-[520px] bg-[url('https://ik.imagekit.io/kvimages/IT%20Services/20945549.jpg?updatedAt=1719039854765')] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
