    ...
    return (
        <>
            <section className="w-full">
                <div className="w-full h-[520px] bg-[url('https://ik.imagekit.io/kvimages/it-services-images/19199000.jpg?updatedAt=1719041190552')] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
