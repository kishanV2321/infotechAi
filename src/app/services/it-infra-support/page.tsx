    ...
    return (
        <>
            <section className="w-full">
                <div className="w-full h-[520px] bg-[url('https://ik.imagekit.io/kvimages/it-services-images/it-infra.jpg?updatedAt=1719041190511')] bg-cover bg-no-repeat bg-center relative">
                    {/* Overlay for opacity */}
