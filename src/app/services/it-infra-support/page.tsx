...
function ITinfraSupport() {
    return (
        <>
            <section className="w-full">
                <div className="w-full h-[520px] bg-[url('https://ik.imagekit.io/kvimages/it-services-images/it-infra.jpg?updatedAt=1719041190511')] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center bg-opacity-25">
                    <div className="flex flex-col items-center mx-auto px-4 pt-6 md:px-8 text-center">
                        <h1 className="text-white font-bold text-4xl md:text-6xl leading-tight mb-6">IT Infrastructure Support and Service</h1>
                        <p className="text-white text-lg md:text-2xl mb-6">The Best in IT Infrastructure Support and Service.</p>
                        <div className='w-fit'>
            ...
            <div className='bg-slate-900 flex flex-col items-center gap-10 lg:flex-row justify-center text-white'>
                <div className="my-24 flex w-[90%] lg:w-[70%] flex-col gap-10">
                    ...
                    IT Infrastructure Support and Service
                    </h1>
                    ...
                    <p className="text-base md:text-lg font-medium text-center">
                    Revolutionize your IT landscape with our all-encompassing hardware, software, network, storage, firewall, and backup solutions. Our expert team ensures seamless integration and unmatched reliability to keep your business running smoothly.
                    </p>
                </div>
            </div>
