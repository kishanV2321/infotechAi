                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between lg:justify-center">
                        <div className='my-24 flex lg:w-[80%] flex-col gap-10'>
                            ...
                            <p className="text-base font-medium lg:w-[95%]">
                                At Digital4India, our third-party technical support for VMware offers a comprehensive alternative to manufacturer services, ensuring that your VMware environment remains stable and efficient. We provide an improved and collaborative approach to addressing software, operating system, hypervisor, and compatibility issues affecting your supported VMware devices. Our team of experienced technicians is dedicated to reviewing, advising, and resolving any concerns promptly, allowing you to focus on your core business objectives without disruptions.
                            </p>
                            <p className="text-base font-medium lg:w-[95%]">
                                By choosing Digital4India for your VMware support needs, you can save 30-40% compared to existing Broadcom/VMware licenses while receiving top-tier service. Our commitment to delivering exceptional support means that you gain access to a wealth of knowledge and expertise, ensuring that your VMware infrastructure operates at peak performance. Trust Digital4India to be your reliable partner in navigating the complexities of your VMware environment, providing you with the peace of mind and cost savings that come from expert support.
                            </p>
                        </div>
                    </div>
                </div>
